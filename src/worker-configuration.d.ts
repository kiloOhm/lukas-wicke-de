/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 6523d4755a585c065aaaa806f038ef21)
// Runtime types generated with workerd@1.20250823.0 2025-08-29 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		CF_IMAGES_ACCOUNT_ID: "bc479fff0ed21d18a613d71c1af79682";
		CF_IMAGES_ACCOUNT_HASH: "k1HQsavJfzZQlI3O3ZBS7Q";
		CF_IMAGES_API_TOKEN: string;
		CF_API_TOKEN: string;
		OBJ_STORAGE: R2Bucket;
		DB: D1Database;
		ESS_ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_IMAGES_ACCOUNT_ID" | "CF_IMAGES_ACCOUNT_HASH" | "CF_IMAGES_API_TOKEN" | "CF_API_TOKEN">> {}
}
